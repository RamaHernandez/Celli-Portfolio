...
const projects = [
  ...
  { id: "02.",
    title: "Diseño de Vestuario e Ilustración",
    year: "2025+", 
    category: "DISEÑO Y CONFECCIÓN", 
    tags: ["fashion design", "moldería", "confección"], 
    image: project02Images[0], 
    images: project02Images, 
    description: "Proyecto desarrollado en conjunto a partir del análisis de una película asignada por la cátedra. La propuesta consistió en seleccionar una escena específica y replantear su vestuario mediante una nueva colección capaz de reemplazar visualmente el diseño original. El proceso incluyó investigación conceptual, análisis de personajes y construcción de un banco de referencias visuales, texturas y materiales. Como resultado se diseñaron cinco propuestas de vestuario vinculadas a la escena seleccionada, de las cuales una fue confeccionada y materializada. Participé en todas las etapas del proyecto, concentrando mi aporte principalmente en el diseño e ilustración de los conjuntos, así como en la producción fotográfica utilizada para registrar y comunicar el resultado final." },
  { id: "03.", 
    title: "Diseño de colección / Alicia Orlandi", 
    year: "2025+", 
    category: "DISEÑO Y CONFECCIÓN", 
    tags: ["fashion design", "garment craft", "textiles"], 
    image: project03Images[0], 
    images: project03Images, 
    description: "Proyecto grupal desarrollado en el marco de la facultad a partir del análisis de una obra seleccionada dentro de un museo asignado por la cátedra. El desafío consistió en interpretar la obra elegida y transformarla en propuestas de indumentaria mediante diferentes enfoques conceptuales. A partir de la investigación inicial se desarrollaron dos series compuestas por cuatro conjuntos cada una, explorando distintos partidos de diseño y criterios estéticos. Como etapa final se materializaron dos conjuntos seleccionados, integrando investigación, diseño y confección. Mi participación se centró en el diseño integral de los ocho conjuntos, la elaboración de ilustraciones técnicas y conceptuales, el armado físico de una de las prendas y la producción fotográfica utilizada para documentar el proyecto final." },
  { id: "04.", 
    title: "Diseño de remeras y estampas", 
    year: "2025+", 
    category: "TECHPACK DESIGN", 
    tags: ["product dev", "techpack", "technical design"], 
    image: project04Images[2], 
    images: project04Images, 
    description: "Proyecto de diseño orientado al desarrollo de remeras y estampas para una marca independiente. El trabajo contempló tanto aspectos visuales como decisiones vinculadas a la materialidad y producción de las prendas. Las tareas desarrolladas incluyeron la creación de propuestas gráficas, el diseño de estampas, el asesoramiento en selección de textiles y la colaboración en la organización de talleres y procesos productivos. La experiencia permitió combinar diseño gráfico, diseño de indumentaria y criterios de producción, participando en distintas instancias necesarias para transformar una idea en un producto comercializable."
  },
  { id: "05.", 
    title: "Armado de fichas técnicas // Camisa Patagonia", 
    year: "2025+", category: "DISEÑO GRÁFICO", 
    tags: ["graphic design", "visual media", "fashion design"], 
    image: project05Images[3], images: project05Images, 
    description: "Proyecto orientado al desarrollo de fichas técnicas para una camisa perteneciente a la marca Patagonia dentro de una colección de temporada otoño-invierno. El objetivo fue documentar de manera precisa todos los aspectos necesarios para su correcta producción y seguimiento. El trabajo incluyó la elaboración detallada de documentación técnica vinculada a moldería, confección, avíos, medidas, procesos constructivos y especificaciones de fabricación. Cada instancia fue desarrollada siguiendo criterios profesionales utilizados dentro de la industria de la indumentaria. Este proyecto me permitió profundizar conocimientos relacionados con desarrollo de producto, documentación técnica y comunicación entre diseño y producción, herramientas fundamentales dentro de los procesos industriales de moda." },
  { id: "06.", 
    title: "Diseño y confección de saco tweed", 
    year: "2024+", 
    category: "DISEÑO DE INDUMENTARIA", 
    tags: ["trend vision", "fashion design", "conceptual"], image: project06Images[4], images: project06Images, 
    description: "Proyecto realizado en el marco de la facultad, donde la consigna consistía en desarrollar una prenda sastrera a partir de un modelo asignado por la cátedra. El trabajo abordó tanto los aspectos técnicos de construcción como la documentación necesaria para su producción. El proceso incluyó el desarrollo de la moldería, la selección de textiles y avíos, la confección de la prenda y la elaboración de las fichas técnicas correspondientes. Como parte del proyecto también se desarrolló una identidad de marca específica para presentar el producto terminado. Mi participación se centró principalmente en el armado de las fichas técnicas, el diseño de la identidad visual de la propuesta, el desarrollo del logo y la creación de la etiqueta de producto, integrando aspectos técnicos y de comunicación visual dentro de un mismo proyecto." },
  { id: "07.", title: "Diseño y confección de Jean", 
    year: "2024+", 
    category: "VESTUARIO / ILUSTRACIÓN", 
    tags: ["styling", "illustration", "art direction"], 
    image: project07Images[5], 
    images: project07Images, 
    description: "Proyecto desarrollado en el marco de la facultad a partir de un diseño base de jean proporcionado por la cátedra. El desafío consistió en reinterpretar el modelo original mediante modificaciones de diseño que permitieran generar una propuesta propia, manteniendo criterios técnicos de construcción y confección. El proceso incluyó el desarrollo de la moldería, la adaptación del diseño inicial, la selección de textiles y la planificación de la confección. Como instancia final, se incorporaron detalles bordados que complementaron la identidad visual de la prenda y aportaron valor al resultado final. Todas las etapas del proyecto fueron realizadas íntegramente por mí, incluyendo la elaboración de la moldería, el desarrollo del diseño, la selección de materiales, la confección y la ejecución de los bordados, permitiéndome aplicar conocimientos técnicos y creativos en un producto terminado." },
